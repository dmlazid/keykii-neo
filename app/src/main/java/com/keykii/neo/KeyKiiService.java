    ...
    class KeyKiiThemeDecorDrawable
        ...
        public void draw(
            ...
            if(
                ...
                // 2.44.4: keep the stable 2.44.2 theme layout,
                // then add only a light per-theme accent.
                drawSmallThemeAccent(
                    canvas,
                    w,
                    h
                );
        ...
        void drawSmallThemeAccent(
            ...
            switch(pack) {
                case 100:
                    drawTintedThemeAsset(canvas,R.drawable.theme_motif_flower,soft,135,w*.28f,h*.03f,dp(22));
                    drawTintedThemeAsset(canvas,R.drawable.theme_motif_cherry,accent,145,w*.62f,h*.78f,dp(24));
                    break;

                case 101:
                    drawTintedThemeAsset(canvas,R.drawable.theme_motif_star,soft,150,w*.30f,h*.04f,dp(18));
                    drawTintedThemeAsset(canvas,R.drawable.theme_motif_star,soft,120,w*.58f,h*.77f,dp(15));
                    break;

                case 102:
                    drawTintedThemeAsset(canvas,R.drawable.theme_motif_leaf,accent,135,w*.31f,h*.03f,dp(22));
                    drawTintedThemeAsset(canvas,R.drawable.theme_motif_leaf,soft,120,w*.63f,h*.78f,dp(20));
                    break;

                case 103:
                    drawTintedThemeAsset(canvas,R.drawable.theme_motif_heart,soft,135,w*.30f,h*.04f,dp(20));
                    drawTintedThemeAsset(canvas,R.drawable.theme_motif_cake,accent,135,w*.62f,h*.76f,dp(24));
                    break;

                case 104:
                    drawTintedThemeAsset(canvas,R.drawable.theme_motif_flower,soft,130,w*.30f,h*.03f,dp(20));
                    drawTintedThemeAsset(canvas,R.drawable.theme_motif_butterfly,accent,145,w*.61f,h*.77f,dp(23));
                    break;

                case 105:
                    drawTintedThemeAsset(canvas,R.drawable.theme_motif_star,Color.CYAN,150,w*.30f,h*.04f,dp(18));
                    drawTintedThemeAsset(canvas,R.drawable.theme_motif_bubble,Color.MAGENTA,125,w*.61f,h*.77f,dp(23));
                    break;

                case 106:
                    drawTintedThemeAsset(canvas,R.drawable.theme_motif_heart,soft,140,w*.29f,h*.04f,dp(18));
                    drawTintedThemeAsset(canvas,R.drawable.theme_motif_strawberry,accent,145,w*.61f,h*.76f,dp(23));
                    break;

                case 107:
                    drawTintedThemeAsset(canvas,R.drawable.theme_motif_star,soft,145,w*.30f,h*.04f,dp(18));
                    drawTintedThemeAsset(canvas,R.drawable.theme_motif_cloud,Color.WHITE,125,w*.59f,h*.77f,dp(26));
                    break;

                case 108:
                    drawTintedThemeAsset(canvas,R.drawable.theme_motif_leaf,soft,135,w*.29f,h*.03f,dp(20));
                    drawTintedThemeAsset(canvas,R.drawable.theme_motif_flower,Color.WHITE,130,w*.62f,h*.77f,dp(20));
                    break;

                case 109:
                    drawTintedThemeAsset(canvas,R.drawable.theme_motif_bow,soft,135,w*.30f,h*.03f,dp(21));
                    drawTintedThemeAsset(canvas,R.drawable.theme_motif_heart,accent,125,w*.61f,h*.77f,dp(19));
                    break;

                case 110:
                    drawTintedThemeAsset(canvas,R.drawable.theme_motif_flower,soft,130,w*.30f,h*.03f,dp(20));
                    drawTintedThemeAsset(canvas,R.drawable.theme_motif_bow,accent,140,w*.61f,h*.77f,dp(22));
                    break;

                case 111:
                    drawTintedThemeAsset(canvas,R.drawable.theme_motif_cherry,accent,145,w*.30f,h*.03f,dp(21));
                    drawTintedThemeAsset(canvas,R.drawable.theme_motif_cup,soft,135,w*.61f,h*.76f,dp(23));
                    break;

                case 112:
                    drawTintedThemeAsset(canvas,R.drawable.theme_motif_star,Color.WHITE,145,w*.30f,h*.04f,dp(18));
                    drawTintedThemeAsset(canvas,R.drawable.theme_motif_bubble,soft,135,w*.60f,h*.76f,dp(23));
                    break;

                case 113:
                    drawTintedThemeAsset(canvas,R.drawable.theme_motif_heart,soft,125,w*.30f,h*.04f,dp(18));
                    drawTintedThemeAsset(canvas,R.drawable.theme_motif_cup,accent,140,w*.61f,h*.76f,dp(23));
                    break;

                case 114:
                    drawTintedThemeAsset(canvas,R.drawable.theme_motif_bow,soft,145,w*.30f,h*.03f,dp(22));
                    drawTintedThemeAsset(canvas,R.drawable.theme_motif_heart,accent,130,w*.61f,h*.77f,dp(19));
                    break;

                case 115:
                    drawTintedThemeAsset(canvas,R.drawable.theme_motif_flower,accent,145,w*.29f,h*.03f,dp(22));
                    drawTintedThemeAsset(canvas,R.drawable.theme_motif_lotus,soft,130,w*.61f,h*.76f,dp(24));
                    break;

                case 117:
                    drawTintedThemeAsset(canvas,R.drawable.theme_motif_heart,accent,120,w*.30f,h*.04f,dp(18));
                    drawTintedThemeAsset(canvas,R.drawable.theme_motif_bow,soft,120,w*.61f,h*.77f,dp(20));
                    break;

                case 118:
                    drawTintedThemeAsset(canvas,R.drawable.theme_motif_star,accent,125,w*.30f,h*.04f,dp(17));
                    drawTintedThemeAsset(canvas,R.drawable.theme_motif_butterfly,soft,145,w*.61f,h*.76f,dp(23));
                    break;

                case 119:
                    drawTintedThemeAsset(canvas,R.drawable.theme_motif_snow,Color.WHITE,145,w*.30f,h*.03f,dp(20));
                    drawTintedThemeAsset(canvas,R.drawable.theme_motif_gift,accent,145,w*.61f,h*.76f,dp(23));
                    break;
            }
        }
